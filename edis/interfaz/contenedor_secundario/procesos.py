...
from edis.nucleo import manejador_de_archivo
from edis.interfaz.contenedor_secundario import salida_compilador
from edis.interfaz.dialogos.preferencias import preferencias_compilacion as pc
