...
class MenuArchivo(QObject):
    ...
    def __init__(self, menu_archivo, ide):
        ...
        ACCIONES = ({
        'nombre': 'Nuevo',
        'conexion': self.ide.contenedor_editor.agregar_editor
            },
        {
        'nombre': 'Abrir',
        ...
        for accion in ACCIONES:
            ...
            menu_archivo.addAction(qaccion)
        ...
        #self.accionNuevo = crear_accion(self, "Nuevo", icono=_ICONO['new'],
            #atajo=_ATAJO['nuevo'],
            #slot=self.ide.contenedor_editor.agregar_editor)
        ...
        #self.accionAbrir = crear_accion(self, "Abrir", icono=_ICONO['open'],
            #atajo=_ATAJO['abrir'],
            #slot=self.ide.contenedor_editor.abrir_archivo)
        ## Guardar
