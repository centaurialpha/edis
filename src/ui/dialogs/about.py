...
class AcercaDe(QDialog):
    ...
    def __init__(self, parent):
        ...
        lbl_link = QLabel("<a href='%s'><span style='color: #0197FD;'>"
                          "Web</span></a>" % ui.__web__)
        lbl_sc = QLabel(self.tr("<a href='{0}'><span style="
                        "'color: #0197FD;'>Source Code</span></a>").format(
                        ui.__codigo_fuente__))
